...
%define %attribute_custom2_static(Class, AttributeType, AttributeName, GetMethod, SetMethod, GetMethodCall, SetMethodCall)
  %ignore Class::GetMethod();
  %ignore Class::GetMethod() const;
  #if #SetMethod != #AttributeName
    %ignore Class::SetMethod;
...
%define %attribute_readonly2_static(Class, AttributeType, AttributeName, GetMethod, GetMethodCall)
  %ignore Class::GetMethod();
  %ignore Class::GetMethod() const;
  %immutable Class::AttributeName;
  %extend Class {
...
%define %attribute_custom_static(Class, AttributeType, AttributeName, GetMethod, SetMethod, GetMethodCall, SetMethodCall)
  %ignore Class::GetMethod();
  %ignore Class::GetMethod() const;
  #if #SetMethod != #AttributeName
    %ignore Class::SetMethod;
...
%define %attribute_readonly_static(Class, AttributeType, AttributeName, GetMethod, GetMethodCall)
  %ignore Class::GetMethod();
  %ignore Class::GetMethod() const;
  %immutable Class::AttributeName;
  %extend Class {
...
%define %attribute_static(Class, AttributeType, AttributeName, GetMethod, SetMethod...)
  #if #SetMethod != ""
    %attribute_custom_static(%arg(Class), %arg(AttributeType), AttributeName, GetMethod, SetMethod, GetMethod(), SetMethod(val_))
  #else
    %attribute_readonly_static(%arg(Class), %arg(AttributeType), AttributeName, GetMethod, GetMethod())
  #endif
%enddef
...
%define %attribute2_static(Class, AttributeType, AttributeName, GetMethod, SetMethod...)
  #if #SetMethod != ""
    %attribute_custom2_static(%arg(Class), %arg(AttributeType), AttributeName, GetMethod, SetMethod, GetMethod(), SetMethod(*val_))
  #else
    %attribute_readonly2_static(%arg(Class), %arg(AttributeType), AttributeName, GetMethod, GetMethod())
  #endif
%enddef
...
%define %attributestring_static(Class, AttributeType, AttributeName, GetMethod, SetMethod...)
  %{
...
%define %attributeval_static(Class, AttributeType, AttributeName, GetMethod, SetMethod...)
  %{
    #define %mangle(Class) ##_## AttributeName ## _get() new AttributeType(Class ## :: ## GetMethod())
  %}
  #if #SetMethod != ""
